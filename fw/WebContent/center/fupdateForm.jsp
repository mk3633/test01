...
<form action="fupdatePro.jsp?pageNum=<%=pageNum %>" method="post" name="fr"  
enctype="multipart/form-data">
<input type="hidden" name="num" value="<%=num%>">
<table id="notice2">
<tr><td class="ftwrite">글쓴이</td>
   <td class="fttitle">
   <input type="text" class="ftext" name="name" value="<%=id%>" readonly></td></tr>
<tr><td class="ftwrite">비밀번호</td>
    <td class="fttitle"><input type="password" name="pass"></td></tr>
<tr><td class="ftwrite">제목</td>
    <td class="fttitle"><input type="text" name="subject" style="width:500px;" value="<%=bb.getSubject()%>"></td></tr>
<tr><td class="ftwrite">파일</td>
    <td class="fttitle"><input type="file" name="file">
    <input type="hidden" name="orifile" value="<%=bb.getFile()%>">
    <%=bb.getFile() %></td></tr>  
<tr><td class="ftwrite">글내용</td>
    <td class="fttitle"><textarea name="content" rows="10" cols="20"><%=bb.getContent()%></textarea></td></tr>
</table>
